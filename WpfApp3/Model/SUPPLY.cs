...
namespace WpfApp3.Model
{
    class SUPPLY : BindableBase
    {
        ...
        {
            get { return GetValue<String>(nameof(SupplyID)); }
            set { SetValue(value, nameof(SupplyID)); }
        }

        public String SupplyPID
        {
            get { return GetValue<String>(nameof(SupplyPID)); }
            set { SetValue(value, nameof(SupplyPID)); }
        }

        public String RoutingActionLabel
        {
            get { return GetValue<String>(nameof(RoutingAction)); }
            set { SetValue(value, nameof(RoutingAction)); }
        }
